  ...
  constructor(opts) {
    ...
    if (typeof this.client.defineCommand === 'function') {
      this.client.defineCommand('rlflxIncr', {
        numberOfKeys: 1,
        lua: RateLimiterRedis.incrTtlLuaScript,
      });
    }
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      if (forceExpire) {
        ...
        if (typeof this.client.rlflxIncr === 'function') {
          ...
          this.client.eval(RateLimiterRedis.incrTtlLuaScript, 1, rlKey, points, secDuration, incrCallback);
        }
      } else {
...
RateLimiterRedis.incrTtlLuaScript = `redis.call('set', KEYS[1], 0, 'EX', ARGV[2], 'NX') \
